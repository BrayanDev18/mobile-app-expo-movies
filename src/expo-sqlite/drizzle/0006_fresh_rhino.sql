...
CREATE TABLE `__new_cast_credits` (
...
INSERT INTO `__new_cast_credits`("id", "name", "character", "profile_path", "adult", "credit_id", "order", "original_title", "original_language", "popularity", "vote_average", "vote_count", "cast_id") SELECT "id", "name", "character", "profile_path", "adult", "credit_id", "order", "original_title", "original_language", "popularity", "vote_average", "vote_count", "cast_id" FROM `cast_credits`;--> statement-breakpoint
DROP TABLE `cast_credits`;--> statement-breakpoint
ALTER TABLE `__new_cast_credits` RENAME TO `cast_credits`;--> statement-breakpoint
...
CREATE TABLE `__new_movie_details` (
	...
	`vote_average` real DEFAULT 0,
	`vote_count` integer DEFAULT 0,
	`last_updated` integer DEFAULT 1763045702 NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `cast_details` ADD `cast_id` integer NOT NULL REFERENCES movie_cast(id);--> statement-breakpoint
ALTER TABLE `cast_images` ADD `cast_id` integer NOT NULL REFERENCES movie_cast(id);