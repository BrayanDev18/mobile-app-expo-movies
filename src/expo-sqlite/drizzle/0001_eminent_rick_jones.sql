...
--> statement-breakpoint
INSERT INTO `__new_movie_cast`("id", "name", "character", "profile_path", "movie_id") SELECT "id", "name", "character", "profile_path", "movie_id" FROM `movie_cast`;--> statement-breakpoint
DROP TABLE `movie_cast`;--> statement-breakpoint
ALTER TABLE `__new_movie_cast` RENAME TO `movie_cast`;--> statement-breakpoint
...
CREATE TABLE `__new_movie_details` (
	...
	`last_updated` integer DEFAULT 1759869083 NOT NULL
);
--> statement-breakpoint
