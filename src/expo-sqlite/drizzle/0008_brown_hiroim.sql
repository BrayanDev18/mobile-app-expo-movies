ALTER TABLE `cast_credits` RENAME COLUMN "name" TO "title";--> statement-breakpoint
ALTER TABLE `cast_credits` ADD `overview` text;--> statement-breakpoint
ALTER TABLE `cast_credits` ADD `release_date` text;--> statement-breakpoint
ALTER TABLE `cast_credits` ADD `video` integer DEFAULT false;--> statement-breakpoint
ALTER TABLE `cast_credits` ADD `genre_ids` text;--> statement-breakpoint
...
CREATE TABLE `__new_movie_details` (
	...
	`last_updated` integer DEFAULT 1763053562 NOT NULL
);
