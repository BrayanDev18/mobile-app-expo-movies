...
CREATE TABLE `__new_cast_images` (
...
INSERT INTO `__new_cast_images`("id", "profiles", "cast_id") SELECT "id", "profiles", "cast_id" FROM `cast_images`;--> statement-breakpoint
DROP TABLE `cast_images`;--> statement-breakpoint
ALTER TABLE `__new_cast_images` RENAME TO `cast_images`;--> statement-breakpoint
...
CREATE TABLE `__new_movie_details` (
	...
	`last_updated` integer DEFAULT 1763056589 NOT NULL
);
--> statement-breakpoint
