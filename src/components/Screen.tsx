...
interface BaseScreenProps {
  ...
  className?: string;
  /**
   * Whether the screen should have a back button. Defaults to false.
   */
  canGoBack?: boolean;
  /**
   * Whether the background should be transparent. Defaults to false.
   */
...
export function Screen(props: ScreenProps) {
  ...
  return (
    <>
      {canGoBack ? <RowBack /> : null}

      <View
        style={[$containerInsets]}
        className={cn(
          'h-full w-full flex-1',
          !transparentBackground && 'bg-neutral-900',
          className
        )}>
        <KeyboardAvoidingView
